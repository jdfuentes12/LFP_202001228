...
_lr_productions = [
  ...
  ('INSTIPO -> LLAA RTIPO LLAC instrucciones_2 LLAA DIV RTIPO LLAC','INSTIPO',8,'p_instruccionTipo','analizador_lexico.py',192),
  ('INSTEXTO -> LLAA RTEXTO LLAC CADENA LLAA DIV RTEXTO LLAC','INSTEXTO',8,'p_instruccionTexto','analizador_lexico.py',196),
  ('INSTFUNCION -> LLAA RFUNCION IGUAL RESCRIBIR LLAC instrucciones_2 LLAA DIV RFUNCION LLAC','INSTFUNCION',10,'p_instruccionFuncion','analizador_lexico.py',200),
  ('INSTESTILO -> LLAA RESTILO LLAC instrucciones_2 LLAA DIV RESTILO LLAC','INSTESTILO',8,'p_instruccionEstilo','analizador_lexico.py',204),
  ...
  ('instruccion_2 -> LLAA RDESCRIPCION LLAC CORA RTEXTO2 CORC LLAA DIV RDESCRIPCION LLAC','instruccion_2',10,'p_instruccion_2_descripcion','analizador_lexico.py',240),
  ('instruccion_2 -> LLAA RCONTENIDO LLAC CORA RTIPO2 CORC LLAA DIV RCONTENIDO LLAC','instruccion_2',10,'p_instruccion_2_contenido','analizador_lexico.py',244),
  ('instruccion_2 -> LLAA RTITULO RCOLOR IGUAL COLOR RTAMANIO IGUAL ENTERO DIV LLAC','instruccion_2',10,'p_instruccion_2_titulo_2','analizador_lexico.py',248),
  ('instruccion_2 -> LLAA RDESCRIPCION RCOLOR IGUAL COLOR RTAMANIO IGUAL ENTERO DIV LLAC','instruccion_2',10,'p_instruccion_2_descripcion_2','analizador_lexico.py',252),
  ('instruccion_2 -> LLAA RCONTENIDO RCOLOR IGUAL COLOR RTAMANIO IGUAL ENTERO DIV LLAC','instruccion_2',10,'p_instruccion_2_contenido_2','analizador_lexico.py',256),
  ('COLOR -> RAZUL','COLOR',1,'p_color','analizador_lexico.py',260),
  ('COLOR -> RVERDE','COLOR',1,'p_color','analizador_lexico.py',261),
  ('COLOR -> RROJO','COLOR',1,'p_color','analizador_lexico.py',262),
  ('COLOR -> RNEGRO','COLOR',1,'p_color','analizador_lexico.py',263),
  ('COLOR -> RBLANCO','COLOR',1,'p_color','analizador_lexico.py',264),
  ('COLOR -> RGRIS','COLOR',1,'p_color','analizador_lexico.py',265),
  ('COLOR -> RCELESTE','COLOR',1,'p_color','analizador_lexico.py',266),
  ('COLOR -> RCAFE','COLOR',1,'p_color','analizador_lexico.py',267),
  ('tipo -> RSUMA','tipo',1,'p_tipo','analizador_lexico.py',271),
  ('tipo -> RRESTA','tipo',1,'p_tipo','analizador_lexico.py',272),
  ('tipo -> RMULTIPLICACION','tipo',1,'p_tipo','analizador_lexico.py',273),
  ('tipo -> RDIVISION','tipo',1,'p_tipo','analizador_lexico.py',274),
  ('tipo -> RINVERSO','tipo',1,'p_tipo','analizador_lexico.py',275),
  ('tipo -> RRAIZ','tipo',1,'p_tipo','analizador_lexico.py',276),
  ('tipo -> RPOTENCIA','tipo',1,'p_tipo','analizador_lexico.py',277),
  ('tipo -> RSENO','tipo',1,'p_tipo','analizador_lexico.py',278),
  ('tipo -> RCOSENO','tipo',1,'p_tipo','analizador_lexico.py',279),
  ('tipo -> RTANGENTE','tipo',1,'p_tipo','analizador_lexico.py',280),
]
